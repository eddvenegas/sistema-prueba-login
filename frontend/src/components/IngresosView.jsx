...
const API_URL = 'http://localhost:5000/api/movimientos/ingresos';
...
const IngresosView = ({ trimestreMeses, trimestreId, directorId }) => {
        ...
        {trimestreMeses.map((mes, index) => (
          <button
            ...
            className={`px-8 py-4 text-sm font-bold transition-all border-r border-gray-200 flex items-center gap-2 ${
              mesActivo === index
                ? 'bg-white text-green-600 border-t-4 border-t-green-600 shadow-sm'
      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-800">
            RELACION DE INGRESOS - {trimestreMeses[mesActivo].toUpperCase()}
          </h2>
          <button
            onClick={() => agregarFila(mesActivo)}
            className="flex items-center gap-2 bg-emerald-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-emerald-700 transition-all shadow-md font-medium"
          >
          ...
          <table className="w-full border-collapse border border-gray-300 text-sm">
            ...
            <tbody>
                  ...
                  <td className="border border-gray-300 p-1">
                    ...
                    >
                      <input
                        ...
                        aria-hidden="true"
                      />
                      <span className="block w-full p-1 text-center font-mono text-sm text-gray-700 group-hover:bg-blue-100 rounded pointer-events-none">
              ...
              <tr className="bg-gray-50 font-bold">
                ...
                <td className="border border-gray-300 p-2 text-right text-green-700 font-mono text-lg bg-green-50">
        ...
        <div className="mt-8 flex justify-end">
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-all font-bold shadow-lg disabled:bg-gray-400"
          >
